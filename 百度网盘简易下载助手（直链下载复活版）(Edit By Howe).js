...
// @description  ████ 20211031满速接口依然可用 ████一个纯净好用的直链下载助手，绝无多余附加功能。免SVIP会员，免安装浏览器扩展，无视黑号。只要你有个IDM或Aria2，就能享受极速下载的快感！👍👍👍👍👍 热烈庆祝评论超2000 👍👍👍👍👍
...
(function () {
    ...
    let globalData = {
        ...
        paramDomain2: `https://s3.bmp.ovh`, // 教程跳转地址
    }
    ...
    let initButtonEvent = function () {
        ...
        let isOldHome = isOldHomePage();
        let isNewHome = isNewHomePage();
        if (yunData || isOldHome) {
            //暂时限制只能在管理页面中使用
            if (!isOldHome) {
            ...
            <div id="downloadDialog">
                ...
                <div id="dialogMiddle">
                    <div id="dialogLeft">
                        ...
                        <div id="dialogQr">
                            <img id="dialogQrImg" src="https://s3.bmp.ovh/imgs/2021/10/14264e4c03dcb86f.gif" />
                        </div>
                    </div>
                    <div id="dialogRight">
